...
\item \textbf{Seconda Settimana - Backend NestJS: Fondamenti (40 ore)}
\begin{itemize}
    \item Introduzione a NestJS 11 (controller, service, module);
    \item Strutturazione del progetto e best practices;
    \item Creazione API REST base;
    \item Testing base delle API;
\end{itemize}

\item \textbf{Terza Settimana - Persistenza e CRUD (40 ore)}
\begin{itemize}
    \item Connessione a database PostgreSQL 18 (Supabase);
    \item Modellazione dati e schema delle entità del gestionale interno;
    \item Implementazione CRUD completo;
    \item Validazione degli input e gestione degli errori;
    \item Test di integrazione tra API e database;
\end{itemize}

\item \textbf{Quarta Settimana - Autenticazione e Autorizzazione (40 ore)}
\begin{itemize}
    \item Implementazione autenticazione JWT;
    \item Gestione utenti e ruoli base;
    \item Middleware, guard e validazioni;
    \item Protezione degli endpoint e gestione delle sessioni;
\end{itemize}

\item \textbf{Quinta Settimana - Frontend con Next.js (40 ore)}
\begin{itemize}
...
\item \textbf{Sesta Settimana - SaaS, Multitenancy e Caching (40 ore)}
\begin{itemize}
    ...
    \item Introduzione a Redis 8 per caching e ottimizzazione performance;
    \item Estensione del progetto esistente;
\end{itemize}

\item \textbf{Settima Settimana - Infrastruttura e Architetture Scalabili (40 ore)}
\begin{itemize}
    ...
    \item Cenni a RabbitMQ 4 e code di messaggi per processi asincroni;
    \item Cenni a API Gateway con Kong Gateway 3.10 LTS e concetti di microservizi;
\end{itemize}
